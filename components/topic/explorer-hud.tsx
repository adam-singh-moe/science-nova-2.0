...
export function ExplorerHUD({ topicTitle, studyAreaName, gradeLevel }: ExplorerHUDProps) {
  ...
  const handleAskProfessorNova = () => {
    setShowAIChat(true)
  }

  return (
    <>
      {/* Sticky Explorer's HUD */}
      <div className="fixed top-0 left-0 right-0 z-50 backdrop-blur-lg bg-gradient-to-r from-blue-600/90 via-purple-600/90 to-indigo-600/90 border-b-2 border-white/20 shadow-2xl">
        ...
        >
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between gap-4">
              ...
              {/* Right Section - Ask Professor Nova Button */}
              <div className="flex-shrink-0">
                ...
                >
                  <Button
                    onClick={handleAskProfessorNova}
                    className="bg-gradient-to-r from-amber-400 to-yellow-500 hover:from-amber-500 hover:to-yellow-600 text-amber-900 font-bold px-4 py-2 rounded-full shadow-lg border-2 border-amber-300 hover:border-amber-200 transition-all duration-300"
                    style={{
        ...
        <div
          className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 transition-all duration-300"
