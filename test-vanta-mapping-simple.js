...
function testVantaFallbackMappings() {
...
function testImageGenerationFailureFlow() {
...
function testStoryPageInterface() {
...
function runAllTests() {
  ...
  try {
    testVantaFallbackMappings()
    testImageGenerationFailureFlow()
    testStoryPageInterface()
